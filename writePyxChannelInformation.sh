...
echo "Axmlns:atom http://www.w3.org/2005/Atom"
echo "Aversion 2.0"
echo "(channel"
echo "(atom:link"
echo "Ahref $podcastRSSFeedURL"
echo "Arel self"
echo "Atype application/rss+xml"
echo ")atom:link"
echo "(title"
echo "-$podcastTitle"
echo ")title"
...
echo "(itunes:owner"
echo "(itunes:name"
echo "-$podcastOwnerName"
echo ")itunes:name"
echo "(itunes:email"
echo "-$podcastOwnerEmail"
echo ")itunes:email"
echo ")itunes:owner"
